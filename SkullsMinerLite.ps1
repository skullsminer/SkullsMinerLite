param(
    ...
    [String]$Wallet = "1Q9BoPvEgtUv6SFiYMaVABBwprTo5yBb6H", 
    [Parameter(Mandatory=$false)]
    [String]$UserName = "skullsminer", 
    [Parameter(Mandatory=$false)]
    [String]$WorkerName = "ID=skullsminer", 
    [Parameter(Mandatory=$false)]
    [Int]$API_ID = 0, 
    [Parameter(Mandatory=$false)]
    [String]$API_Key = "", 
    ...
    [Parameter(Mandatory=$false)]
    [String]$Location = "EU", #europe/us/asia
    [Parameter(Mandatory=$false)]
    [Switch]$SSL = $false, 
    [Parameter(Mandatory=$false)]
...
@"
SkullsMinerLite
Copyright (c) 2021 Skulldeath

This program comes with ABSOLUTELY NO WARRANTY.
This is free software, and you are welcome to redistribute it
under certain conditions.

SkullsMinerLite is licensed under the GNU General Public License v3.0
...
Function PrepareWriteConfig{
    ...
    $MainForm.Refresh
    # [windows.forms.messagebox]::show("Please restart SkullsMinerLite",'Config saved','ok','Information') | out-null
}
...
$Config | Add-Member -Force -MemberType ScriptProperty -Name "PoolsConfig" -Value {
    If (Test-Path ".\Config\PoolsConfig.json"){
        ...
        [PSCustomObject]@{default=[PSCustomObject]@{
            Wallet = "1Q9BoPvEgtUv6SFiYMaVABBwprTo5yBb6H"
            UserName = "skullsminer"
            WorkerName = "skullsminer"
